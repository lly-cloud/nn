...
def render_dashboard(elapsed, speed, max_speed, signs,
                     ...
                     fps=None, vehicle_count=None, remaining=None):
    """
    在控制台绘制实时状态面板
    ...
    remaining_str = f"  /  -{int(remaining)}s" if remaining else ""
    ...
    lines.append(f"  {Style.BOLD}{time_str}{remaining_str}{Style.RESET}    {speed_str}    {Style.DIM}{max_str}  {fps_str}{Style.RESET}")
